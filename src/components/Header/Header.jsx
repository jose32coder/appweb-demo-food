...
function Header() {
  return (
    <div className="h-[40vw] my-8 mx-auto bg-[url('/header_img.png')] bg-contain bg-no-repeat relative" id="inicio">
        <div className="absolute flex flex-col items-start gap-2 sm:gap-5 max-w-[50%] bottom-[10%] left-[6vw] text-white header-contents">
            ...
            <button style={{ fontSize: 'max(1vw, 14px)' }} className="border-non text-md sm:text-lg text-[#747474] font-medium rounded-md bg-white py-1 px-5 sm:px-9 hover:bg-gray-300 duration-200">Ver Menú</button>
        </div>
    </div>
  )
}
