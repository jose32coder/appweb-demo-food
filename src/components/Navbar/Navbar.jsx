  ...
  return (
    <div className="fixed top-0 left-0 w-full z-40 h-auto">
      <div className="flex px-[2.5%] justify-between items-center w-full relative bg-white py-3">
        ...
        <div
          className="flex gap-5 w-auto lg:gap-8 items-center md:ml-auto z-10 px-2 md:px-0"
          ref={registerBtnRef}
        >
          <div className="relative cursor-pointer">
            <Link to="/cart">
              <img src={assets.basket_icon} className="w-6 md:min-w-6" alt="" />
            </Link>
            {cartItemCount > 0 && (
      ...
      {/* Menú móvil */}
      <div
        className={`fixed top-0 left-0 w-full h-full bg-black transition-opacity duration-300 ease-in-out ${
          isMenuOpen ? "opacity-50 z-40" : "opacity-0 z-0 hidden"
        }`}
        onClick={() => setIsMenuOpen(false)}
      ></div>
      <div
        className={`fixed top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] w-full max-w-sm h-full max-h-96 bg-white transition-transform duration-300 ease-in-out ${
          isMenuOpen ? "-translate-y-50 z-50" : "translate-y-[100vh] z-0"
        }`}
      >
        <button
          ...
          <ul className="flex flex-col items-center gap-5">
            ...
            <a href="#appMovil">
              <li
                ...
                className={
                  isHomePage && activeId === "appMovil" ? "active" : ""
                }
              >
                App Móvil
              </li>
            ...
            <a href="#contacto">
              <li
                ...
                className={
                  isHomePage && activeId === "contacto" ? "active" : ""
                }
              >
                Contacto
              </li>
