...
export default function Cart() {
	const { itemsCart, food_list, removeCart, setItemQuantity } = useContext(StoreContext);
	...
	const handleRemoveItem = (itemId) => {
		removeCart(itemId); // Elimina el ítem del carrito
	};
	...
	const handleProcessPayment = () => {
		// Aquí puedes agregar cualquier lógica adicional para procesar el pago

		// Redirigir a la página de PlaceOrder
		navigate('/order');
	};

	return (
		<div className="flex flex-col items-center mt-10 w-full min-h-auto">
				...
				<div className="w-full max-w-4xl bg-white p-4 md:p-6 rounded-lg shadow-lg">
					...
					<div className="flex flex-col md:flex-row justify-between mt-6">
						...
						<button
							...
							onClick={handleProcessPayment}  // Llama a la función para procesar el pago y redirigir
						>
							Procesar pago
						</button>
					</div>
